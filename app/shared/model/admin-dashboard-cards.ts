...
export var ADMIN_DASHBOARD_CARDS = [
    ...
    new DashboardCard("Projects", "The place to add a new project. See a list of all ongoing/future projects.",
        "/project", "../../../../images/projects.jpg"),

    new DashboardCard("Employees", "Just hired a new employee? Add it here. See a list of " +
        "all current employees with their schedules of availability.",
    ...
    new DashboardCard("Pending requests", "A place to approve the requested days off from your employees.",
